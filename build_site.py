...
<dialog class="tiers criteria-dlg" id="criteriaDlg" aria-labelledby="criteriaDlgTitle">
  ...
  <div class="criteria-list">
    ...
    <div class="criterion-def"><h4>Бенефиты и преимущества работы</h4><p><span class="badge warn">Некритичная</span>Нет или изменена формулировка хотя бы одного из пяти фиксированных пунктов гайда.</p></div>
    ...
    <div class="criterion-def"><h4>Структура и оформление</h4><p><span class="badge warn">Некритичная</span>Пропущен обязательный блок; дополнительные требования («желательно» и подобные) остались в обязательных требованиях, а не вынесены отдельно; ошибки оформления списков; нарушена логика названия; в Product &amp; Tech нет примеров будущих задач.</p></div>
  </div>
...
const RECRUITER_TO_LEAD = {
  ...
  'Евелева Анна': 'Екатерина Миронова', 'Жижко Екатерина': 'Валерия Ильницкая',
  'Захарова Юлия': 'Людмила Бодрова',
