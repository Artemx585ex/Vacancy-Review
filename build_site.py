...
<dialog class="tiers criteria-dlg" id="criteriaDlg" aria-labelledby="criteriaDlgTitle">
  ...
  <div class="criteria-list">
    <div class="criterion-def"><h4>Соблюдение законодательства</h4><p><span class="badge crit">Критичная</span>Запрещённые слова; требования, нарушающие законодательство; дискриминирующие требования.<br><span class="badge warn">Некритичная</span>Нет конкретных требований, по которым можно корректно отказать кандидату.</p></div>
    <div class="criterion-def"><h4>Бенефиты и преимущества работы</h4><p><span class="badge crit">Критичная</span>Нет или изменена формулировка хотя бы одного из пяти фиксированных пунктов гайда.<br><span class="badge warn">Некритичная</span>Нет ни одного дополнительного преимущества из гайда (TVP).</p></div>
    <div class="criterion-def"><h4>Орфография и типографика</h4><p><span class="badge crit">Критичная</span>Названия продуктов не соответствуют редполитике; «Avito» написано латиницей; есть опечатки или грамматические ошибки.<br><span class="badge warn">Некритичная</span>Любые другие ошибки из блока типографики.</p></div>
    <div class="criterion-def"><h4>Структура и оформление</h4><p><span class="badge crit">Критичная</span>Пропущен обязательный блок; дополнительные требования («желательно» и подобные) остались в обязательных требованиях, а не вынесены отдельно.<br><span class="badge warn">Некритичная</span>Дисбаланс объёма полей более 30%; ошибки оформления списков; нарушена логика названия; в Product &amp; Tech нет примеров будущих задач.</p></div>
